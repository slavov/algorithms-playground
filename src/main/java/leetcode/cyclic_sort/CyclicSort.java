 ...
 *
 * <p>Write a function to sort the objects in-place on their creation sequence number in O(n) and
 ...
 * <p>Example 1:
 *
 * <p>Input: [3, 1, 5, 4, 2] Output: [1, 2, 3, 4, 5] Example 2:
 *
 * <p>Input: [2, 6, 4, 3, 1, 5] Output: [1, 2, 3, 4, 5, 6] Example 3:
 *
