 ...
 * <p>Example 1:
 *
 * <p>Input: intervals = [[1,3],[6,9]], newInterval = [2,5] Output: [[1,5],[6,9]] Example 2:
 *
 * <p>Input: intervals = [[1,2],[3,5],[6,7],[8,10],[12,16]], newInterval = [4,8] Output:
 * [[1,2],[3,10],[12,16]] Explanation: Because the new interval [4,8] overlaps with
 * [3,5],[6,7],[8,10].
 *
 * <p>LeetCode: <a href="https://leetcode.com/problems/insert-interval/">57. Insert Interval</a>
 */
