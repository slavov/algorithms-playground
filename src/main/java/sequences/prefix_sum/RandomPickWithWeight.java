 ...
 * <p>Note:
 *
 * <p>1 <= w.length <= 10000 1 <= w[i] <= 10^5 pickIndex will be called at most 10000 times. Example
 * 1:
 *
 * <p>Input: ["Solution","pickIndex"] [[[1]],[]] Output: [null,0] Example 2:
 *
 * <p>Input: ["Solution","pickIndex","pickIndex","pickIndex","pickIndex","pickIndex"]
 * [[[1,3]],[],[],[],[],[]] Output: [null,0,1,1,1,0]
 *
 * <p>LeetCode: <a href="https://leetcode.com/problems/random-pick-with-weight/">528. Random Pick
 * with Weight</a>
 */
