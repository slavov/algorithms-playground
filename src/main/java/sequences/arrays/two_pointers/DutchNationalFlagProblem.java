 ...
 *
 * <p>The flag of the Netherlands consists of three colors: red, white and blue; and since our input
 * array also consists of three different numbers that is why it is called Dutch National Flag
 * problem.
 *
 * <p>Example 1:
 *
 * <p>Input: [1, 0, 2, 1, 0] Output: [0 0 1 1 2] Example 2:
 *
 * <p>Input: [2, 2, 0, 1, 2, 0] Output: [0 0 1 2 2 2 ]
 */
