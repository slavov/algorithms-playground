 ...
 * <p>Example 1:
 *
 * <p>Input: [-2, 0, 1, 2], target=2 Output: 1 Explanation: The triplet [-2, 1, 2] has the closest
 * sum to the target. Example 2:
 *
 * <p>Input: [-3, -1, 1, 2], target=1 Output: 0 Explanation: The triplet [-3, 1, 2] has the closest
 * sum to the target. Example 3:
 *
 * <p>Input: [1, 0, 1, 1], target=100 Output: 3 Explanation: The triplet [1, 1, 1] has the closest
 * sum to the target.
 */
