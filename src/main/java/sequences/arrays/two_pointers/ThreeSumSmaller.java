 ...
 * <p>Example 1:
 *
 * <p>Input: [-1, 0, 2, 3], target=3 Output: 2 Explanation: There are two triplets whose sum is less
 * than the target: [-1, 0, 3], [-1, 0, 2] Example 2:
 *
 * <p>Input: [-1, 4, 2, 1, 3], target=5 Output: 4 Explanation: There are four triplets whose sum is
 * less than the target: [-1, 1, 4], [-1, 1, 3], [-1, 1, 2], [-1, 2, 3]
 */
